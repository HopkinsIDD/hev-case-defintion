...
This is for at least ONE symptom in children. 
...
for (batch in 1:num_batches) {
  ...
  saveRDS(batch_df, file = paste0("case_def_children_batch_ssd", batch, ".rds"))
}
...
for (batch in 1:num_batches) {
  path <- here("scripts", "Case_definitions", "SSD batches", paste0("case_def_children_batch_ssd", batch, ".rds"))
...
informative_sub <- informative %>% filter(sensitivity>0.40 & specificity>0.4)
...
tabyl(dat_ssd_symp$case_def147)
tabyl(dat_ssd_symp, case_def147, infect_bin)
